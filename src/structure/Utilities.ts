import { ChannelType, APIAuditLogChange } from "discord.js";

export class Utilities {
    public static channelTypeString(type: ChannelType) {
        switch(type) {
    ...
    public static auditLogKey(key: APIAuditLogChange['key']) {
