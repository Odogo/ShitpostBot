...
export default new ShitCommand({
    name: "resume",
    description: "Resumes the media player, if it was paused",
    ...
    run: async (client, interaction, options) => {
        ...
        await Media.toggleMediaPlayer(guild, true);
        await interaction.reply({ content: "The player is resuming! You can pause it with `/pause`" });
    }
});